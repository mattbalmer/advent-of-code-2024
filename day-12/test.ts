...
const TEST_DATA_4 = getTestData(12, 4);
const TEST_DATA_5 = getTestData(12, 5);
...
describe(`Day 12`, () => {
  ...
  describe('part 2', () => {
    ...
    it('should work on test case 4', () => {
      const expected = 236;
      const result = execute(part2, TEST_DATA_4, format);

      expect(result).to.equal(expected);
    });

    it('should work on test case 5', () => {
      const expected = 368;
      const result = execute(part2, TEST_DATA_5, format);
